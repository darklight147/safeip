...
func init() {
	...
	rootCmd.Flags().StringVarP(&customMask, "mask", "m", "XXX.XXX.XXX.XXX", "Custom mask to use")
	rootCmd.Flags().StringVarP(&customDnsRegex, "dns-regex", "d", `(\b(?:[a-zA-Z0-9-]+\.){2,}[a-zA-Z]{2,}\b)`, "Custom regex to use for DNS-like entries")
